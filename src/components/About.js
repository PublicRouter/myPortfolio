...
function About() {
  return (
    <div className='min-h-[80vh] sm:min-h-[72vh] flex justify-center items-center'>
        <div className='w-4/5 lg:w-3/5 text-center rounded-xl border-4 border-blue-500 bg-gradient-to-r from-cyan-500 to-blue-500 '>
            <section className='font-OpenSans text-white p-4 mb-4 mt-4 mx-4 bg-blue-400 border-2 rounded-xl text-sm md:text-base'>
                <h1 className='font-DancingScript text-center text-white text-2xl font-bold mb-2 tracking-wide'>About Me</h1>
