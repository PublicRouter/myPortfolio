...
export default function Experience() {
  return (
    <>
        <h2 className="font-Oswald min-h-[6vh] flex justify-center items-center text-xl font-bold text-blue-600 tracking-wider">Skills</h2>
        <div className="min-h-[70vh] w-[75vw] sm:w-[65vw] grid grid-cols-1 sm:grid-cols-2 gap-x-2 gap-y-4 mx-auto pb-2 pt-3 text-sm">
            ...
            {/* SKILL BOXES */}
            <div className="bg-blue-500 opacity-[.88] rounded-lg shadow-gray shadow-lg min-h-[50px] md:min-h-[100px] flex flex-col items-center p-2">
            ...
            <div className="bg-blue-500 opacity-[.88] rounded-lg shadow-gray shadow-lg min-h-[50px] md:min-h-[100px] flex flex-col items-center p-2">
                ...
                <div className="font-OpenSans flex flex-wrap flex-row w-[100%] sm:w-[23vw] pt-2">
                    <ul className='display-inline list-none no-underline flex flex-row flex-wrap'>
                        ...
                        <li className='mr-1 mb-1 min-w-[5vw] bg-green-400 shadow-lg p-1 rounded-lg shadow-lg min-h-[20px] text-center text-white'>OSS Model</li>
                    </ul>
                </div>
            </div>
        </div>
